...
export class ExteriorFrontBehindCameraUpdater extends CameraUpdater {
    ...
    update(delta: number): void {
        ...
        if (this.lookAtTarget) {
            ...
            // Behind the player on the axis joining both aircraft; aim at the
            // midpoint so neither plane falls out of frame.
            placeDuelAxisCamera(this.camera, playerPos, enemyPos, -1, this._v, this._p);
            return;
        }
