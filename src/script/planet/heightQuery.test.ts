...
describe('toneForTriangle', () => {
    ...
    it('keeps all-land triangles as land', () => {
        assert.notEqual(toneForTriangle(50, 60, 70, 0), TerrainTone.Water);
        assert.notEqual(toneForTriangle(50, 60, 70, 0), TerrainTone.ShallowWater);
    });
