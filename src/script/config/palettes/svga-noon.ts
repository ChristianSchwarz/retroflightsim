...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_CLOUD]: ['#f5f5f0', '#c4d2dc'],
    [PaletteCategory.SKY_SUN]: '#fff6df',

    [PaletteCategory.TERRAIN_DEFAULT]: '#3f6044',
    [PaletteCategory.TERRAIN_SAND]: '#6d6a4e',
    [PaletteCategory.TERRAIN_GRASS]: '#3f6044',
    [PaletteCategory.TERRAIN_BARE]: '#5a4a3c',
    [PaletteCategory.TERRAIN_FOREST]: '#2f5238',
    [PaletteCategory.TERRAIN_SCRUB]: '#4f5c3c',
    [PaletteCategory.TERRAIN_CROP]: '#5c6a3a',
    ...
    [PaletteCategory.SCENERY_TREE_FOLIAGE]: ['#497a51', '#68a066'],
    [PaletteCategory.SCENERY_TREE_SHADOW]: ['#000000', '#2a2a2a'],
    [PaletteCategory.SCENERY_TREE_TRUNK]: '#6b4423',
    [PaletteCategory.SCENERY_WOOD_PATCH]: ['#324134', '#497a51'],
