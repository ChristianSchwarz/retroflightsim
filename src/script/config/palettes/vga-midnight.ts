...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_CLOUD]: ['#8888AA', '#403858'],
    [PaletteCategory.SKY_SUN]: '#4a3418',

    [PaletteCategory.TERRAIN_DEFAULT]: '#003000',
    [PaletteCategory.TERRAIN_SAND]: '#3a3020',
    [PaletteCategory.TERRAIN_GRASS]: '#003000',
    [PaletteCategory.TERRAIN_BARE]: '#281a10',
    [PaletteCategory.TERRAIN_FOREST]: '#02200a',
    [PaletteCategory.TERRAIN_SCRUB]: '#242a10',
    [PaletteCategory.TERRAIN_CROP]: '#30340a',
    [PaletteCategory.TERRAIN_URBAN]: '#2e2c28',
    [PaletteCategory.TERRAIN_SNOW]: '#4a4a58',
    [PaletteCategory.TERRAIN_WETLAND]: '#0a2418',
    ...
    [PaletteCategory.SCENERY_TREE_FOLIAGE]: ['#0b1d00', '#148214'],
    [PaletteCategory.SCENERY_TREE_SHADOW]: ['#000000', '#1a1a1a'],
    [PaletteCategory.SCENERY_TREE_TRUNK]: '#2a1810',
    [PaletteCategory.SCENERY_WOOD_PATCH]: ['#072b07', '#0b1d00'],
    ...
    [PaletteCategory.SCENERY_BASE_CONCRETE]: '#2e2e2e',
