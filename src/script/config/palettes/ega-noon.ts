...
const colors: PaletteColors = {
    ...
    [PaletteCategory.TERRAIN_BARE]: EGA_GREEN,
    ...
    [PaletteCategory.SCENERY_MOUNTAIN_BARE]: [EGA_GREEN, EGA_BLACK],
    ...
    [PaletteCategory.SCENERY_TREE_SHADOW]: [EGA_GREEN, EGA_BLACK],
    [PaletteCategory.SCENERY_TREE_TRUNK]: EGA_YELLOW,
    [PaletteCategory.SCENERY_WOOD_PATCH]: [EGA_GREEN, EGA_BLACK_BRIGHT],
    [PaletteCategory.SCENERY_BIOME_PINE_PATCH]: [EGA_GREEN, EGA_BLACK_BRIGHT],
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: [EGA_GREEN_BRIGHT, EGA_GREEN],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: [EGA_GREEN_BRIGHT, EGA_CYAN],
    [PaletteCategory.SCENERY_BIOME_SCRUB_PATCH]: [EGA_YELLOW, EGA_RED],
    [PaletteCategory.SCENERY_BIOME_PINE_FOLIAGE]: [EGA_GREEN, EGA_BLACK],
    [PaletteCategory.SCENERY_BIOME_BUSH_FOLIAGE]: [EGA_GREEN_BRIGHT, EGA_GREEN],
    [PaletteCategory.SCENERY_BIOME_SCRUB_FOLIAGE]: [EGA_YELLOW, EGA_YELLOW_BRIGHT],
    [PaletteCategory.SCENERY_BIOME_BIRCH_FOLIAGE]: [EGA_GREEN_BRIGHT, EGA_YELLOW],
