...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_CLOUD]: ['#505050', '#2c2c2c'],
    [PaletteCategory.SKY_SUN]: '#f0f0f0',
    ...
    [PaletteCategory.TERRAIN_FOREST]: '#2a2a2a',
    [PaletteCategory.TERRAIN_SCRUB]: '#303030',
    [PaletteCategory.TERRAIN_CROP]: '#363636',
    [PaletteCategory.TERRAIN_URBAN]: '#3c3c3c',
    [PaletteCategory.TERRAIN_SNOW]: '#484848',
    [PaletteCategory.TERRAIN_WETLAND]: '#282828',
    [PaletteCategory.TERRAIN_WATER]: '#1d1d1d',
    [PaletteCategory.TERRAIN_SHALLOW_WATER]: '#1d1d1d',
    [PaletteCategory.SCENERY_MOUNTAIN_GRASS]: ['#303030', '#404040'],
    [PaletteCategory.SCENERY_MOUNTAIN_BARE]: ['#303030', '#404040'],
    ...
    [PaletteCategory.SCENERY_TREE_FOLIAGE]: ['#616161', '#727272'],
    [PaletteCategory.SCENERY_TREE_SHADOW]: ['#000000', '#303030'],
    [PaletteCategory.SCENERY_TREE_TRUNK]: '#585858',
    [PaletteCategory.SCENERY_WOOD_PATCH]: ['#525252', '#616161'],
    [PaletteCategory.SCENERY_BIOME_PINE_PATCH]: ['#464646', '#525252'],
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: ['#4a4a4a', '#565656'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: ['#484848', '#545454'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_PATCH]: ['#444444', '#505050'],
    [PaletteCategory.SCENERY_BIOME_PINE_FOLIAGE]: ['#4a4a4a', '#565656'],
    [PaletteCategory.SCENERY_BIOME_BUSH_FOLIAGE]: ['#505050', '#5c5c5c'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_FOLIAGE]: ['#545454', '#606060'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_FOLIAGE]: ['#5c5c5c', '#6c6c6c'],
    ...
    [PaletteCategory.SCENERY_BASE_CONCRETE]: '#4b4b4b',
