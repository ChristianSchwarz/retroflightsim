...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_SUN]: '#e8ffe8',

    [PaletteCategory.TERRAIN_DEFAULT]: '#698869',
    [PaletteCategory.TERRAIN_SAND]: '#698869',
    [PaletteCategory.TERRAIN_BARE]: '#5b775b',
    [PaletteCategory.TERRAIN_GRASS]: '#698869',
    [PaletteCategory.TERRAIN_FOREST]: '#587858',
    [PaletteCategory.TERRAIN_SCRUB]: '#698869',
    [PaletteCategory.TERRAIN_CROP]: '#739273',
    [PaletteCategory.TERRAIN_URBAN]: '#7d9c7d',
    [PaletteCategory.TERRAIN_SNOW]: '#8fae8f',
    [PaletteCategory.TERRAIN_WETLAND]: '#5b775b',
    [PaletteCategory.TERRAIN_WATER]: '#374737',
    [PaletteCategory.TERRAIN_SHALLOW_WATER]: '#374737',
    [PaletteCategory.SCENERY_MOUNTAIN_GRASS]: ['#4d644d', '#698869'],
    [PaletteCategory.SCENERY_MOUNTAIN_BARE]: ['#4d644d', '#698869'],
    ...
    [PaletteCategory.SCENERY_TREE_FOLIAGE]: ['#6a8a6a', '#7ea07e'],
    [PaletteCategory.SCENERY_TREE_SHADOW]: ['#000000', '#3e503e'],
    [PaletteCategory.SCENERY_TREE_TRUNK]: '#617e61',
    [PaletteCategory.SCENERY_WOOD_PATCH]: ['#4c634c', '#6a8a6a'],
    [PaletteCategory.SCENERY_BIOME_PINE_PATCH]: ['#3f503f', '#4c634c'],
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: ['#455845', '#526552'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: ['#425042', '#4f624f'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_PATCH]: ['#484840', '#585850'],
    [PaletteCategory.SCENERY_BIOME_PINE_FOLIAGE]: ['#455845', '#526552'],
    [PaletteCategory.SCENERY_BIOME_BUSH_FOLIAGE]: ['#4a624a', '#577057'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_FOLIAGE]: ['#525248', '#626258'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_FOLIAGE]: ['#5a725a', '#7ea07e'],
    ...
    [PaletteCategory.SCENERY_BASE_CONCRETE]: '#6b8a6b',
