...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_CLOUD]: ['#3a4550', '#1c232a'],
    [PaletteCategory.SKY_SUN]: '#3c2a14',

    [PaletteCategory.TERRAIN_DEFAULT]: '#101611',
    [PaletteCategory.TERRAIN_SAND]: '#1a1814',
    [PaletteCategory.TERRAIN_GRASS]: '#101611',
    [PaletteCategory.TERRAIN_BARE]: '#141110',
    [PaletteCategory.TERRAIN_FOREST]: '#0c1410',
    [PaletteCategory.TERRAIN_SCRUB]: '#141610',
    [PaletteCategory.TERRAIN_CROP]: '#16180f',
    [PaletteCategory.TERRAIN_URBAN]: '#141414',
    [PaletteCategory.TERRAIN_SNOW]: '#2a2e30',
    [PaletteCategory.TERRAIN_WETLAND]: '#0e1614',
    [PaletteCategory.TERRAIN_WATER]: '#0f1418',
    [PaletteCategory.TERRAIN_SHALLOW_WATER]: '#11171b',
    [PaletteCategory.SCENERY_MOUNTAIN_GRASS]: ['#0a0e0a', '#101611'],
    [PaletteCategory.SCENERY_MOUNTAIN_BARE]: ['#0a0e0a', '#101611'],
    ...
    [PaletteCategory.SCENERY_TREE_FOLIAGE]: ['#213824', '#324134'],
    [PaletteCategory.SCENERY_TREE_SHADOW]: ['#000000', '#1a1a1a'],
    [PaletteCategory.SCENERY_TREE_TRUNK]: '#2a1810',
    [PaletteCategory.SCENERY_WOOD_PATCH]: ['#121f14', '#213824'],
    [PaletteCategory.SCENERY_BIOME_PINE_PATCH]: ['#0a100c', '#121f14'],
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: ['#0e140e', '#182018'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: ['#0c120c', '#142014'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_PATCH]: ['#141008', '#1c1810'],
    [PaletteCategory.SCENERY_BIOME_PINE_FOLIAGE]: ['#0e160e', '#182018'],
    [PaletteCategory.SCENERY_BIOME_BUSH_FOLIAGE]: ['#121c12', '#1c281c'],
    [PaletteCategory.SCENERY_BIOME_SCRUB_FOLIAGE]: ['#1c1810', '#242018'],
    [PaletteCategory.SCENERY_BIOME_BIRCH_FOLIAGE]: ['#182c1a', '#2e5032'],
    ...
    [PaletteCategory.SCENERY_BASE_CONCRETE]: '#272727',
