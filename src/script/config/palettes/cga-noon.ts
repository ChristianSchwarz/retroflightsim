...
const colors: PaletteColors = {
    ...
    [PaletteCategory.BACKGROUND]: CGA_CYAN,
    ...
    [PaletteCategory.SKY]: CGA_CYAN,
    [PaletteCategory.SKY_CLOUD]: [CGA_WHITE, CGA_CYAN],

    [PaletteCategory.TERRAIN_DEFAULT]: CGA_MAGENTA,
    [PaletteCategory.TERRAIN_SAND]: CGA_MAGENTA,
    [PaletteCategory.TERRAIN_BARE]: CGA_MAGENTA,
    [PaletteCategory.TERRAIN_GRASS]: CGA_MAGENTA,
    ...
    [PaletteCategory.SCENERY_ROAD_MAIN]: CGA_BLACK,
    ...
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: [CGA_CYAN, CGA_MAGENTA],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: [CGA_WHITE, CGA_CYAN],
    ...
    [PaletteCategory.SCENERY_BUILDING_METAL]: CGA_BLACK,
...
export const CGANoonPalette: Palette = {
    colors: colors,
    values: values,
