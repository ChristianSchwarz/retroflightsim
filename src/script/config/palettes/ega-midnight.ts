...
const colors: PaletteColors = {
    ...
    [PaletteCategory.SKY_CLOUD]: [EGA_WHITE, EGA_BLACK_BRIGHT],

    [PaletteCategory.TERRAIN_DEFAULT]: EGA_BLACK_BRIGHT,
    [PaletteCategory.TERRAIN_SAND]: EGA_BLACK_BRIGHT,
    ...
    [PaletteCategory.SCENERY_BIOME_BUSH_PATCH]: [EGA_GREEN_BRIGHT, EGA_BLACK],
    [PaletteCategory.SCENERY_BIOME_BIRCH_PATCH]: [EGA_CYAN, EGA_BLACK],
    [PaletteCategory.SCENERY_BIOME_SCRUB_PATCH]: [EGA_YELLOW, EGA_BLACK],
    [PaletteCategory.SCENERY_BIOME_PINE_FOLIAGE]: [EGA_GREEN, EGA_BLACK_BRIGHT],
    [PaletteCategory.SCENERY_BIOME_BUSH_FOLIAGE]: [EGA_GREEN_BRIGHT, EGA_BLACK],
    [PaletteCategory.SCENERY_BIOME_SCRUB_FOLIAGE]: [EGA_YELLOW, EGA_RED],
    [PaletteCategory.SCENERY_BIOME_BIRCH_FOLIAGE]: [EGA_GREEN, EGA_YELLOW],
